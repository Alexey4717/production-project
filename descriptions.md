...
При размонтировании компонента (return) нужно так же убрать его store.reducerManager.remove('loginForm');
...
Падали скриншотные тесты, т.к. в сторибуке не отображаются ошибки 
